...
public class Interfaz_Proyecto2 extends javax.swing.JFrame {
    ...
    private void ExploradorArchivoActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    ...
    private void fieldnewnameMouseClicked(java.awt.event.MouseEvent evt) {                                          
        fieldnewname.selectAll();
    }                                         

    private void newdocsizeActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    }                                          

    private void fieldnewnameActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
    }                                            

    private void newdocnameMouseClicked(java.awt.event.MouseEvent evt) {                                        
        newdocname.selectAll();
    }                                       

    private void newdocsizeMouseClicked(java.awt.event.MouseEvent evt) {                                        
        newdocsize.selectAll();
    }                                       

    private void newdoctypeMouseClicked(java.awt.event.MouseEvent evt) {                                        
    ...
    private void deletedocboxActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
    }                                            

    private void createdocbuttonActionPerformed(java.awt.event.ActionEvent evt) {                                                
        if(list.getpFirst() == null){
    ...
    private void printdocbuttonActionPerformed(java.awt.event.ActionEvent evt) {                                               
        if(list.getpFirst() == null){
            JOptionPane.showMessageDialog(this, "Primero debe cargar los usuarios.\n(Pestaña Usuarios)","ALERTA", JOptionPane.WARNING_MESSAGE);
            return;
        }
